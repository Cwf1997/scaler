...
Click the "Fork" button in the top-right corner of the [GitHub repository](https://github.com/Cwf1997/scaler). This will create a copy of the repository on your own GitHub account.
...
Navigate to the `scaler` directory in the terminal, and run the following command:
